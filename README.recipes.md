...
&mdash; **def [analyze\_collect\_result](/recipe_modules/fuchsia/api.py#1090)(self, step_name, result, build_dir):**
...
&mdash; **def [analyze\_test\_results](/recipe_modules/fuchsia/api.py#1138)(self, step_name, test_results):**
...
&mdash; **def [report\_test\_results](/recipe_modules/fuchsia/api.py#1161)(self, test_results):**
...
&mdash; **def [run\_bloaty](/recipe_modules/fuchsia/api.py#1566)(self, build_results):**
...
&mdash; **def [test](/recipe_modules/fuchsia/api.py#1007)(self, build, test_pool, timeout_secs=(40 \* 60), pave=True, external_network=False):**
...
&mdash; **def [upload\_build\_artifacts](/recipe_modules/fuchsia/api.py#1399)(self, build_results, bucket, upload_breakpad_symbols=False):**
