...
&mdash; **def [analyze\_collect\_result](/recipe_modules/fuchsia/api.py#1110)(self, step_name, result, zircon_build_dir):**
...
&mdash; **def [analyze\_test\_results](/recipe_modules/fuchsia/api.py#1153)(self, step_name, test_results):**
...
&mdash; **def [build](/recipe_modules/fuchsia/api.py#560)(self, target, build_type, packages, variants=(), gn_args=[], ninja_targets=(), test_cmds=(), test_device_type='QEMU'):**
...
&mdash; **def [checkout](/recipe_modules/fuchsia/api.py#252)(self, manifest, remote, project=None, revision=None, patch_ref=None, patch_gerrit_url=None, patch_project=None, snapshot_gcs_bucket=None, timeout_secs=(20 \* 60)):**
...
&mdash; **def [checkout\_patched\_snapshot](/recipe_modules/fuchsia/api.py#344)(self, patch_gerrit_url, patch_issue, patch_project, patch_ref, patch_repository_url, timeout_secs=(20 \* 60)):**
...
&mdash; **def [checkout\_snapshot](/recipe_modules/fuchsia/api.py#299)(self, repository, revision, timeout_secs=(20 \* 60)):**
...
&mdash; **def [report\_test\_results](/recipe_modules/fuchsia/api.py#1177)(self, test_results):**
...
&emsp; **@property**<br>&mdash; **def [results\_dir\_on\_host](/recipe_modules/fuchsia/api.py#700)(self):**
...
&emsp; **@property**<br>&mdash; **def [results\_dir\_on\_target](/recipe_modules/fuchsia/api.py#695)(self):**

The directory on target to which target test results will be written.

&mdash; **def [run\_bloaty](/recipe_modules/fuchsia/api.py#1549)(self, build_results):**
...
&mdash; **def [test](/recipe_modules/fuchsia/api.py#1080)(self, build, timeout_secs=(40 \* 60), external_network=False):**
...
&mdash; **def [test\_on\_host](/recipe_modules/fuchsia/api.py#710)(self, build):**
...
&mdash; **def [RunSteps](/recipe_modules/fuchsia/examples/fuchsia.py#126)(api, project, manifest, remote, checkout_snapshot, snapshot_repository, snapshot_revision, patch_gerrit_url, patch_issue, patch_project, patch_ref, patch_repository_url, target, build_type, packages, variants, gn_args, ninja_targets, run_tests, runtests_args, device_type, run_host_tests, networking_for_tests, snapshot_gcs_bucket, upload_breakpad_symbols):**
...
&mdash; **def [RunSteps](/recipes/fuchsia_perf.py#125)(api, project, manifest, remote, target, build_type, packages, variant, gn_args, catapult_url, device_type, dashboard_masters_name, dashboard_bots_name, patch_ref, patch_gerrit_url, patch_project, snapshot_gcs_bucket, upload_to_dashboard, benchmarks_package):**
...
[DEPS](/recipes/sdk.py#12): [cipd](#recipe_modules-cipd), [fuchsia](#recipe_modules-fuchsia), [go](#recipe_modules-go), [gsutil](#recipe_modules-gsutil), [hash](#recipe_modules-hash), [jiri](#recipe_modules-jiri), [recipe\_engine/context][recipe_engine/recipe_modules/context], [recipe\_engine/file][recipe_engine/recipe_modules/file], [recipe\_engine/json][recipe_engine/recipe_modules/json], [recipe\_engine/path][recipe_engine/recipe_modules/path], [recipe\_engine/platform][recipe_engine/recipe_modules/platform], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/python][recipe_engine/recipe_modules/python], [recipe\_engine/step][recipe_engine/recipe_modules/step]

Recipe for building Fuchsia SDKs.

&mdash; **def [RunSteps](/recipes/sdk.py#72)(api, patch_gerrit_url, patch_project, patch_ref, patch_storage, patch_repository_url, project, manifest, remote, revision):**

&mdash; **def [UploadArchive](/recipes/sdk.py#187)(api, sdk, out_dir, revision):**

&mdash; **def [UploadPackage](/recipes/sdk.py#143)(api, sdk_name, staging_dir, revision):**
...
&mdash; **def [RunSteps](/recipes/tools.py#99)(api, category, patch_gerrit_url, patch_project, patch_ref, patch_storage, patch_repository_url, project, manifest, remote, revision, target, packages):**
...
&mdash; **def [Build](/recipes/zircon.py#599)(api, target, toolchain, make_args, src_dir, test_cmd, needs_blkdev, device_type):**

Builds zircon and returns a path to the build output directory.

&mdash; **def [FinalizeTestsTasks](/recipes/zircon.py#512)(api, core_task, booted_task, booted_task_output_image, build_dir):**
...
&mdash; **def [GenerateQEMUCommand](/recipes/zircon.py#388)(target, cmdline, use_kvm, blkdev=''):**
...
&mdash; **def [RunSteps](/recipes/zircon.py#683)(api, patch_gerrit_url, patch_project, patch_ref, patch_storage, patch_repository_url, project, manifest, remote, revision, target, toolchain, make_args, use_kvm, run_tests, runtests_args, device_type, run_host_tests):**

&mdash; **def [RunTestsInQEMU](/recipes/zircon.py#252)(api, target, build_dir, use_kvm):**
...
&mdash; **def [RunTestsOnDevice](/recipes/zircon.py#181)(api, target, build_dir, device_type):**
...
&mdash; **def [RunTestsOnHost](/recipes/zircon.py#135)(api, build_dir):**
...
&mdash; **def [TriggerTestsTask](/recipes/zircon.py#448)(api, name, cmd, arch, use_kvm, isolated_hash, output='', timeout_secs=(60 \* 60)):**
