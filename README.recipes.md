...
&mdash; **def [analyze\_collect\_result](/recipe_modules/fuchsia/api.py#1319)(self, step_name, result, build_dir):**
...
&mdash; **def [analyze\_test\_results](/recipe_modules/fuchsia/api.py#1367)(self, test_results):**
...
&mdash; **def [checkout](/recipe_modules/fuchsia/api.py#217)(self, build_input, manifest, remote, project=None, snapshot_gcs_buckets=(), timeout_secs=(20 \* 60)):**
...
&mdash; **def [report\_test\_results](/recipe_modules/fuchsia/api.py#1389)(self, test_results):**
...
&mdash; **def [run\_bloaty](/recipe_modules/fuchsia/api.py#1795)(self, build_results):**
...
&mdash; **def [upload\_build\_artifacts](/recipe_modules/fuchsia/api.py#1608)(self, build_results, bucket, upload_breakpad_symbols=False):**
...
&mdash; **def [checkout](/recipe_modules/jiri/api.py#311)(self, manifest, remote, project=None, build_input=None, timeout_secs=None, run_hooks=True):**
...
&mdash; **def [checkout\_snapshot](/recipe_modules/jiri/api.py#387)(self, snapshot, timeout_secs=None):**
...
&mdash; **def [read\_manifest\_element](/recipe_modules/jiri/api.py#404)(self, manifest, element_type, element_name):**
...
&mdash; **def [RunSteps](/recipes/sdk.py#46)(api, project, manifest, remote):**

&mdash; **def [UploadArchive](/recipes/sdk.py#195)(api, sdk, out_dir, remote, revision):**

&mdash; **def [UploadPackage](/recipes/sdk.py#155)(api, sdk_name, staging_dir, remote, revision):**
