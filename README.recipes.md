...
&mdash; **def [analyze\_test\_results](/recipe_modules/fuchsia/api.py#1158)(self, step_name, test_results):**
...
&mdash; **def [report\_test\_results](/recipe_modules/fuchsia/api.py#1182)(self, test_results):**
...
&mdash; **def [upload\_build\_artifacts](/recipe_modules/fuchsia/api.py#1423)(self, build_results, bucket, upload_breakpad_symbols=False):**
