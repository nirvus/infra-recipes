...
&mdash; **def [analyze\_collect\_result](/recipe_modules/fuchsia/api.py#1341)(self, step_name, result, build_dir):**
...
&mdash; **def [analyze\_test\_results](/recipe_modules/fuchsia/api.py#1389)(self, test_results):**
...
&mdash; **def [build](/recipe_modules/fuchsia/api.py#581)(self, target, build_type, packages, variants=(), gn_args=[], ninja_targets=(), boards=[], products=[], zircon_args=[], collect_build_metrics=False, build_for_testing=False, build_archive=False):**
...
&mdash; **def [report\_test\_results](/recipe_modules/fuchsia/api.py#1415)(self, test_results):**
...
&emsp; **@property**<br>&mdash; **def [results\_dir\_on\_host](/recipe_modules/fuchsia/api.py#736)(self):**
...
&emsp; **@property**<br>&mdash; **def [results\_dir\_on\_target](/recipe_modules/fuchsia/api.py#731)(self):**
...
&mdash; **def [test\_in\_shards](/recipe_modules/fuchsia/api.py#1199)(self, test_pool, build, timeout_secs=(40 \* 60)):**
...
&mdash; **def [test\_on\_host](/recipe_modules/fuchsia/api.py#746)(self, build):**
...
&mdash; **def [upload\_build\_results](/recipe_modules/fuchsia/api.py#1563)(self, build_results, gcs_bucket=None, upload_breakpad_symbols=False):**
