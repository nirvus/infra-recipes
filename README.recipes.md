...
&mdash; **def [analyze\_collect\_result](/recipe_modules/fuchsia/api.py#1054)(self, step_name, result, build_dir):**
...
&mdash; **def [analyze\_test\_results](/recipe_modules/fuchsia/api.py#1100)(self, step_name, test_results):**
...
&mdash; **def [build](/recipe_modules/fuchsia/api.py#541)(self, target, build_type, packages, variants=(), gn_args=[], ninja_targets=(), test_cmds=(), test_device_type='QEMU'):**
...
&mdash; **def [checkout](/recipe_modules/fuchsia/api.py#233)(self, manifest, remote, project=None, revision=None, patch_ref=None, patch_gerrit_url=None, patch_project=None, snapshot_gcs_bucket=None, timeout_secs=(20 \* 60)):**
...
&mdash; **def [checkout\_patched\_snapshot](/recipe_modules/fuchsia/api.py#325)(self, patch_gerrit_url, patch_issue, patch_project, patch_ref, patch_repository_url, timeout_secs=(20 \* 60)):**
...
&mdash; **def [checkout\_snapshot](/recipe_modules/fuchsia/api.py#280)(self, repository, revision, timeout_secs=(20 \* 60)):**
...
&mdash; **def [report\_test\_results](/recipe_modules/fuchsia/api.py#1119)(self, test_results):**
...
&emsp; **@property**<br>&mdash; **def [results\_dir\_on\_host](/recipe_modules/fuchsia/api.py#679)(self):**
...
&emsp; **@property**<br>&mdash; **def [results\_dir\_on\_target](/recipe_modules/fuchsia/api.py#674)(self):**

The directory on target to which target test results will be written.

&mdash; **def [run\_bloaty](/recipe_modules/fuchsia/api.py#1488)(self, build_results):**
...
&mdash; **def [test](/recipe_modules/fuchsia/api.py#1019)(self, build, test_pool, timeout_secs=(40 \* 60), pave=True, external_network=False):**
...
&mdash; **def [test\_on\_host](/recipe_modules/fuchsia/api.py#689)(self, build):**
...
&mdash; **def [upload\_build\_artifacts](/recipe_modules/fuchsia/api.py#1357)(self, build_results, bucket, upload_breakpad_symbols=False):**
...
&mdash; **def [UploadArchive](/recipes/sdk.py#188)(api, sdk, out_dir, remote, revision):**

&mdash; **def [UploadPackage](/recipes/sdk.py#144)(api, sdk_name, staging_dir, remote, revision):**
