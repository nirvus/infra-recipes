...
&mdash; **def [run\_bloaty](/recipe_modules/fuchsia/api.py#1667)(self, build_results):**
...
&mdash; **def [upload\_build\_artifacts](/recipe_modules/fuchsia/api.py#1491)(self, build_results):**
