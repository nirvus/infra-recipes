...
&mdash; **def [analyze\_collect\_result](/recipe_modules/fuchsia/api.py#1185)(self, step_name, result, build_dir):**
...
&mdash; **def [analyze\_test\_results](/recipe_modules/fuchsia/api.py#1233)(self, step_name, test_results):**
...
&mdash; **def [build](/recipe_modules/fuchsia/api.py#541)(self, target, build_type, packages, variants=(), gn_args=[], ninja_targets=(), boards=[], products=[], zircon_args=[]):**
...
&mdash; **def [report\_test\_results](/recipe_modules/fuchsia/api.py#1256)(self, test_results):**
...
&emsp; **@property**<br>&mdash; **def [results\_dir\_on\_host](/recipe_modules/fuchsia/api.py#683)(self):**
...
&emsp; **@property**<br>&mdash; **def [results\_dir\_on\_target](/recipe_modules/fuchsia/api.py#678)(self):**

The directory on target to which target test results will be written.

&mdash; **def [run\_bloaty](/recipe_modules/fuchsia/api.py#1681)(self, build_results):**
...
&mdash; **def [test\_on\_host](/recipe_modules/fuchsia/api.py#693)(self, build):**
...
&mdash; **def [upload\_build\_artifacts](/recipe_modules/fuchsia/api.py#1494)(self, build_results, bucket, upload_breakpad_symbols=False):**
