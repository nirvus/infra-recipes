...
#### **class [FuchsiaApi](/recipe_modules/fuchsia/api.py#143)([RecipeApi][recipe_engine/wkt/RecipeApi]):**
...
&mdash; **def [build](/recipe_modules/fuchsia/api.py#349)(self, target, build_type, packages, variants=(), gn_args=(), ninja_targets=(), test_cmds=(), test_device_type='QEMU'):**
...
&mdash; **def [checkout](/recipe_modules/fuchsia/api.py#172)(self, manifest, remote, project=None, patch_ref=None, patch_gerrit_url=None, patch_project=None, snapshot_gcs_bucket=None, timeout_secs=(20 \* 60)):**
