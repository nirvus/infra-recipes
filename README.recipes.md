...
&mdash; **def [analyze\_collect\_result](/recipe_modules/fuchsia/api.py#1182)(self, step_name, result, build_dir):**
...
&mdash; **def [analyze\_test\_results](/recipe_modules/fuchsia/api.py#1230)(self, step_name, test_results):**
...
&mdash; **def [build](/recipe_modules/fuchsia/api.py#539)(self, target, build_type, packages, variants=(), gn_args=[], ninja_targets=(), boards=[], products=[]):**
...
&mdash; **def [report\_test\_results](/recipe_modules/fuchsia/api.py#1253)(self, test_results):**
...
&emsp; **@property**<br>&mdash; **def [results\_dir\_on\_host](/recipe_modules/fuchsia/api.py#680)(self):**
...
&emsp; **@property**<br>&mdash; **def [results\_dir\_on\_target](/recipe_modules/fuchsia/api.py#675)(self):**

The directory on target to which target test results will be written.

&mdash; **def [run\_bloaty](/recipe_modules/fuchsia/api.py#1678)(self, build_results):**
...
&mdash; **def [test](/recipe_modules/fuchsia/api.py#1066)(self, build, test_pool, test_cmds, device_type, timeout_secs=(40 \* 60), pave=True, external_network=False, requires_secrets=False):**
...
&mdash; **def [test\_on\_host](/recipe_modules/fuchsia/api.py#690)(self, build):**
...
&mdash; **def [upload\_build\_artifacts](/recipe_modules/fuchsia/api.py#1491)(self, build_results, bucket, upload_breakpad_symbols=False):**
...
&mdash; **def [RunSteps](/recipes/fuchsia.py#157)(api, project, manifest, remote, checkout_snapshot, target, build_type, packages, variant, gn_args, test_pool, run_tests, runtests_args, run_host_tests, device_type, networking_for_tests, pave, ninja_targets, test_timeout_secs, requires_secrets, archive_gcs_bucket, upload_breakpad_symbols, snapshot_gcs_bucket, boards, products):**
...
&mdash; **def [RunSteps](/recipe_modules/fuchsia/examples/fuchsia.py#127)(api, project, manifest, remote, checkout_snapshot, target, build_type, packages, variants, gn_args, ninja_targets, run_tests, runtests_args, device_type, run_host_tests, networking_for_tests, requires_secrets, snapshot_gcs_bucket, upload_breakpad_symbols, pave, boards, products):**
...
&mdash; **def [RunSteps](/recipes/fuchsia_perf.py#146)(api, project, manifest, remote, target, build_type, packages, variant, gn_args, ninja_targets, test_pool, catapult_url, device_type, pave, dashboard_masters_name, dashboard_bots_name, snapshot_gcs_bucket, upload_to_dashboard, benchmarks_package, boards, products):**
...
&mdash; **def [UploadArchive](/recipes/sdk.py#186)(api, sdk, out_dir, remote, revision):**

&mdash; **def [UploadPackage](/recipes/sdk.py#150)(api, sdk_name, staging_dir, remote, revision):**
