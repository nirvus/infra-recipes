...
&mdash; **def [analyze\_collect\_result](/recipe_modules/fuchsia/api.py#1127)(self, step_name, result, build_dir):**
...
&mdash; **def [analyze\_test\_results](/recipe_modules/fuchsia/api.py#1175)(self, step_name, test_results):**
...
&mdash; **def [build](/recipe_modules/fuchsia/api.py#490)(self, target, build_type, packages, variants=(), gn_args=[], ninja_targets=()):**
...
&mdash; **def [checkout](/recipe_modules/fuchsia/api.py#219)(self, manifest, remote, project=None, revision=None, patch_ref=None, patch_gerrit_url=None, patch_project=None, snapshot_gcs_bucket=None, timeout_secs=(20 \* 60), include_cherrypicks=False):**
...
&mdash; **def [checkout\_patched\_snapshot](/recipe_modules/fuchsia/api.py#302)(self, patch_gerrit_url, patch_issue, patch_project, patch_ref, patch_repository_url, timeout_secs=(20 \* 60), include_cherrypicks=False):**
...
&mdash; **def [checkout\_snapshot](/recipe_modules/fuchsia/api.py#267)(self, repository, revision, timeout_secs=(20 \* 60), include_cherrypicks=False):**
...
&mdash; **def [report\_test\_results](/recipe_modules/fuchsia/api.py#1198)(self, test_results):**
...
&emsp; **@property**<br>&mdash; **def [results\_dir\_on\_host](/recipe_modules/fuchsia/api.py#625)(self):**
...
&emsp; **@property**<br>&mdash; **def [results\_dir\_on\_target](/recipe_modules/fuchsia/api.py#620)(self):**

The directory on target to which target test results will be written.

&mdash; **def [run\_bloaty](/recipe_modules/fuchsia/api.py#1623)(self, build_results):**
...
&mdash; **def [test](/recipe_modules/fuchsia/api.py#1011)(self, build, test_pool, test_cmds, device_type, timeout_secs=(40 \* 60), pave=True, external_network=False, requires_secrets=False):**
...
&mdash; **def [test\_on\_host](/recipe_modules/fuchsia/api.py#635)(self, build):**
...
&mdash; **def [upload\_build\_artifacts](/recipe_modules/fuchsia/api.py#1436)(self, build_results, bucket, upload_breakpad_symbols=False):**
...
&mdash; **def [RunSteps](/recipes/fuchsia.py#178)(api, project, manifest, remote, revision, checkout_snapshot, repository, patch_gerrit_url, patch_issue, patch_project, patch_ref, patch_repository_url, target, build_type, packages, variant, gn_args, test_pool, run_tests, runtests_args, run_host_tests, device_type, networking_for_tests, pave, ninja_targets, test_timeout_secs, requires_secrets, archive_gcs_bucket, upload_breakpad_symbols, snapshot_gcs_bucket, include_cherrypicks):**
### *recipes* / [fuchsia:examples/fuchsia](/recipe_modules/fuchsia/examples/fuchsia.py)

[DEPS](/recipe_modules/fuchsia/examples/fuchsia.py#17): [fuchsia](#recipe_modules-fuchsia), [goma](#recipe_modules-goma), [swarming](#recipe_modules-swarming), [recipe\_engine/json][recipe_engine/recipe_modules/json], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/raw\_io][recipe_engine/recipe_modules/raw_io]

Recipe for building Fuchsia and running tests.

&mdash; **def [RunSteps](/recipe_modules/fuchsia/examples/fuchsia.py#143)(api, project, manifest, remote, checkout_snapshot, snapshot_repository, snapshot_revision, patch_gerrit_url, patch_issue, patch_project, patch_ref, patch_repository_url, target, build_type, packages, variants, gn_args, ninja_targets, run_tests, runtests_args, device_type, run_host_tests, networking_for_tests, requires_secrets, snapshot_gcs_bucket, upload_breakpad_symbols, pave, include_cherrypicks):**
...
&mdash; **def [RunSteps](/recipes/release/cherry-pick.py#59)(api, branch, cherry_picks, remote, gerrit_project, version):**
...
&mdash; **def [GetNextReleaseTag](/recipes/release/snapshot.py#45)(api):**

&mdash; **def [RunSteps](/recipes/release/snapshot.py#50)(api, branch, builders, remote):**
...
&mdash; **def [UploadArchive](/recipes/sdk.py#183)(api, sdk, out_dir, remote, revision):**

&mdash; **def [UploadPackage](/recipes/sdk.py#143)(api, sdk_name, staging_dir, remote, revision):**
