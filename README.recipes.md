...
&mdash; **def [checkout](/recipe_modules/fuchsia/api.py#221)(self, build_input, manifest, remote, project=None, snapshot_gcs_buckets=(), timeout_secs=(20 \* 60)):**
...
&mdash; **def [checkout\_patched\_snapshot](/recipe_modules/fuchsia/api.py#309)(self, gerrit_change, timeout_secs=(20 \* 60)):**
...
&mdash; **def [run\_bloaty](/recipe_modules/fuchsia/api.py#1804)(self, build_results):**
...
&mdash; **def [upload\_build\_artifacts](/recipe_modules/fuchsia/api.py#1614)(self, build_results, bucket=None, upload_breakpad_symbols=False):**
...
&mdash; **def [RunSteps](/recipes/ffmpeg.py#46)(api, project, snapshot_gcs_bucket):**
