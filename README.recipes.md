...
#### **class [FuchsiaApi](/recipe_modules/fuchsia/api.py#156)([RecipeApi][recipe_engine/wkt/RecipeApi]):**
...
&mdash; **def [upload\_build\_artifacts](/recipe_modules/fuchsia/api.py#1315)(self, build_results, bucket, upload_breakpad_symbols=False):**
