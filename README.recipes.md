...
&mdash; **def [analyze\_collect\_result](/recipe_modules/fuchsia/api.py#1076)(self, step_name, result, build_dir):**
...
&mdash; **def [analyze\_test\_results](/recipe_modules/fuchsia/api.py#1124)(self, step_name, test_results):**
...
&mdash; **def [build](/recipe_modules/fuchsia/api.py#553)(self, target, build_type, packages, variants=(), gn_args=[], ninja_targets=(), test_cmds=(), test_device_type='QEMU'):**
...
&mdash; **def [report\_test\_results](/recipe_modules/fuchsia/api.py#1147)(self, test_results):**
...
&emsp; **@property**<br>&mdash; **def [results\_dir\_on\_target](/recipe_modules/fuchsia/api.py#691)(self):**

The directory on target to which target test results will be written.

&mdash; **def [run\_bloaty](/recipe_modules/fuchsia/api.py#1552)(self, build_results):**
...
&mdash; **def [test](/recipe_modules/fuchsia/api.py#1041)(self, build, test_pool, timeout_secs=(40 \* 60), pave=True, external_network=False):**
...
&mdash; **def [upload\_build\_artifacts](/recipe_modules/fuchsia/api.py#1385)(self, build_results, bucket, upload_breakpad_symbols=False):**
