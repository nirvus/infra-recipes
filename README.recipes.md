...
&mdash; **def [analyze\_collect\_result](/recipe_modules/fuchsia/api.py#1116)(self, step_name, result, build_dir):**
...
&mdash; **def [analyze\_test\_results](/recipe_modules/fuchsia/api.py#1164)(self, step_name, test_results):**
...
&mdash; **def [build](/recipe_modules/fuchsia/api.py#482)(self, target, build_type, packages, variants=(), gn_args=[], ninja_targets=()):**
...
&mdash; **def [checkout\_patched\_snapshot](/recipe_modules/fuchsia/api.py#296)(self, patch_gerrit_url, patch_issue, patch_project, patch_ref, patch_repository_url, timeout_secs=(20 \* 60), include_cherrypicks=False):**
...
&mdash; **def [report\_test\_results](/recipe_modules/fuchsia/api.py#1187)(self, test_results):**
...
&emsp; **@property**<br>&mdash; **def [results\_dir\_on\_host](/recipe_modules/fuchsia/api.py#617)(self):**
...
&emsp; **@property**<br>&mdash; **def [results\_dir\_on\_target](/recipe_modules/fuchsia/api.py#612)(self):**

The directory on target to which target test results will be written.

&mdash; **def [run\_bloaty](/recipe_modules/fuchsia/api.py#1611)(self, build_results):**
...
&mdash; **def [test](/recipe_modules/fuchsia/api.py#1000)(self, build, test_pool, test_cmds, device_type, timeout_secs=(40 \* 60), pave=True, external_network=False, requires_secrets=False):**
...
&mdash; **def [test\_on\_host](/recipe_modules/fuchsia/api.py#627)(self, build):**
...
&mdash; **def [upload\_build\_artifacts](/recipe_modules/fuchsia/api.py#1425)(self, build_results, bucket, upload_breakpad_symbols=False):**
...
&mdash; **def [checkout](/recipe_modules/jiri/api.py#280)(self, manifest, remote, project=None, revision=None, patch_ref=None, patch_gerrit_url=None, patch_project=None, timeout_secs=None):**
...
&mdash; **def [checkout\_snapshot](/recipe_modules/jiri/api.py#319)(self, snapshot, timeout_secs=None):**
...
&mdash; **def [emit\_source\_manifest](/recipe_modules/jiri/api.py#275)(self):**
...
&mdash; **def [patch](/recipe_modules/jiri/api.py#228)(self, ref, host=None, project=None, delete=False, force=False, rebase=False, cherrypick=False):**
...
&mdash; **def [read\_manifest\_element](/recipe_modules/jiri/api.py#336)(self, manifest, element_type, element_name):**
...
&mdash; **def [snapshot](/recipe_modules/jiri/api.py#247)(self, file=None, test_data=None, \*\*kwargs):**

&mdash; **def [source\_manifest](/recipe_modules/jiri/api.py#257)(self, file=None, test_data=None, \*\*kwargs):**
