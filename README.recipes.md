...
&mdash; **def [analyze\_collect\_result](/recipe_modules/fuchsia/api.py#1028)(self, step_name, result, zircon_build_dir):**
...
&mdash; **def [analyze\_test\_results](/recipe_modules/fuchsia/api.py#1071)(self, step_name, test_results):**
...
&mdash; **def [build](/recipe_modules/fuchsia/api.py#535)(self, target, build_type, packages, variants=(), gn_args=[], ninja_targets=(), test_cmds=(), test_device_type='QEMU'):**
...
&mdash; **def [checkout](/recipe_modules/fuchsia/api.py#236)(self, manifest, remote, project=None, revision=None, patch_ref=None, patch_gerrit_url=None, patch_project=None, snapshot_gcs_bucket=None, timeout_secs=(20 \* 60)):**
...
&mdash; **def [checkout\_patched\_snapshot](/recipe_modules/fuchsia/api.py#328)(self, patch_gerrit_url, patch_issue, patch_project, patch_ref, patch_repository_url, timeout_secs=(20 \* 60)):**
...
&mdash; **def [checkout\_snapshot](/recipe_modules/fuchsia/api.py#283)(self, repository, revision, timeout_secs=(20 \* 60)):**
...
&mdash; **def [report\_test\_results](/recipe_modules/fuchsia/api.py#1094)(self, test_results):**
...
&mdash; **def [test](/recipe_modules/fuchsia/api.py#1000)(self, build, timeout_secs=(40 \* 60), external_network=False):**
...
&mdash; **def [upload\_build\_artifacts](/recipe_modules/fuchsia/api.py#1318)(self, build_results, bucket, upload_breakpad_symbols=False):**
...
&mdash; **def [ProcessTestResults](/recipes/fuchsia_perf.py#213)(api, step_name, dashboard_masters_name, dashboard_bots_name, execution_timestamp_ms, test_suite, test_results, catapult_url, upload_to_dashboard, log_url):**
...
&mdash; **def [RunSteps](/recipes/fuchsia_perf.py#127)(api, project, manifest, remote, target, build_type, packages, variant, gn_args, catapult_url, device_type, dashboard_masters_name, dashboard_bots_name, patch_ref, patch_gerrit_url, patch_project, snapshot_gcs_bucket, upload_to_dashboard, benchmarks_package):**
...
[DEPS](/recipes/llvm.py#13): [git](#recipe_modules-git), [gitiles](#recipe_modules-gitiles), [goma](#recipe_modules-goma), [gsutil](#recipe_modules-gsutil), [hash](#recipe_modules-hash), [recipe\_engine/cipd][recipe_engine/recipe_modules/cipd], [recipe\_engine/context][recipe_engine/recipe_modules/context], [recipe\_engine/file][recipe_engine/recipe_modules/file], [recipe\_engine/json][recipe_engine/recipe_modules/json], [recipe\_engine/path][recipe_engine/recipe_modules/path], [recipe\_engine/platform][recipe_engine/recipe_modules/platform], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/python][recipe_engine/recipe_modules/python], [recipe\_engine/raw\_io][recipe_engine/recipe_modules/raw_io], [recipe\_engine/step][recipe_engine/recipe_modules/step], [recipe\_engine/tempfile][recipe_engine/recipe_modules/tempfile]

Recipe for building LLVM.

&mdash; **def [RunSteps](/recipes/llvm.py#50)(api, repository, branch, revision):**
...
&mdash; **def [Build](/recipes/zircon.py#552)(api, target, toolchain, make_args, src_dir, test_cmd, needs_blkdev):**

Builds zircon and returns a path to the build output directory.

&mdash; **def [FinalizeTestsTasks](/recipes/zircon.py#502)(api, core_task, booted_task, booted_task_output_image, build_dir):**
...
&mdash; **def [GenerateQEMUCommand](/recipes/zircon.py#377)(target, cmdline, use_kvm, blkdev=''):**
...
&mdash; **def [RunSteps](/recipes/zircon.py#628)(api, patch_gerrit_url, patch_project, patch_ref, patch_storage, patch_repository_url, project, manifest, remote, revision, target, toolchain, make_args, use_kvm, run_tests, runtests_args, device_type, run_host_tests):**
...
&mdash; **def [RunTestsOnDevice](/recipes/zircon.py#170)(api, target, build_dir, device_type):**
...
&mdash; **def [RunTestsOnHost](/recipes/zircon.py#124)(api, build_dir):**
...
&mdash; **def [TriggerTestsTask](/recipes/zircon.py#438)(api, name, cmd, arch, use_kvm, isolated_hash, output='', timeout_secs=(60 \* 60)):**
...
[recipe_engine/recipe_modules/tricium]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/82e233fa4e6fed0a5dd99501e0d52d3dce25c994/README.recipes.md#recipe_modules-tricium
...
[recipe_engine/wkt/non_step]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/82e233fa4e6fed0a5dd99501e0d52d3dce25c994/recipe_engine/recipe_api.py#716
