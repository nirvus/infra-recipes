...
&mdash; **def [analyze\_collect\_result](/recipe_modules/fuchsia/api.py#1017)(self, step_name, result, build_dir):**
...
&mdash; **def [analyze\_test\_results](/recipe_modules/fuchsia/api.py#1063)(self, step_name, test_results):**
...
&mdash; **def [report\_test\_results](/recipe_modules/fuchsia/api.py#1082)(self, test_results):**
...
&mdash; **def [run\_bloaty](/recipe_modules/fuchsia/api.py#1451)(self, build_results):**
...
&mdash; **def [test](/recipe_modules/fuchsia/api.py#985)(self, build, test_pool, timeout_secs=(40 \* 60), external_network=False):**
...
&mdash; **def [upload\_build\_artifacts](/recipe_modules/fuchsia/api.py#1320)(self, build_results, bucket, upload_breakpad_symbols=False):**
...
&mdash; **def [RunSteps](/recipes/fuchsia_perf.py#135)(api, project, manifest, remote, target, build_type, packages, variant, gn_args, ninja_targets, test_pool, catapult_url, device_type, dashboard_masters_name, dashboard_bots_name, patch_ref, patch_gerrit_url, patch_project, snapshot_gcs_bucket, upload_to_dashboard, benchmarks_package):**
...
&mdash; **def [RunSteps](/recipes/tools.py#100)(api, category, patch_gerrit_url, patch_project, patch_ref, patch_storage, patch_repository_url, project, manifest, remote, revision, target, packages):**
