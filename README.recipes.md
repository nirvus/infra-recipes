...
#### **class [FuchsiaApi](/recipe_modules/fuchsia/api.py#133)([RecipeApi][recipe_engine/wkt/RecipeApi]):**

APIs for checking out, building, and testing Fuchsia.

&mdash; **def [analyze\_collect\_result](/recipe_modules/fuchsia/api.py#1326)(self, step_name, result, build_dir):**
...
&mdash; **def [analyze\_test\_results](/recipe_modules/fuchsia/api.py#1374)(self, test_results):**
...
&mdash; **def [build](/recipe_modules/fuchsia/api.py#574)(self, target, build_type, packages, variants=(), gn_args=[], ninja_targets=(), boards=[], products=[], zircon_args=[]):**
...
&mdash; **def [checkout](/recipe_modules/fuchsia/api.py#243)(self, build_input, manifest, remote, project=None, timeout_secs=(20 \* 60)):**
...
&mdash; **def [report\_test\_results](/recipe_modules/fuchsia/api.py#1400)(self, test_results):**
...
&emsp; **@property**<br>&mdash; **def [results\_dir\_on\_host](/recipe_modules/fuchsia/api.py#716)(self):**
...
&emsp; **@property**<br>&mdash; **def [results\_dir\_on\_target](/recipe_modules/fuchsia/api.py#711)(self):**

The directory on target to which target test results will be written.

&mdash; **def [run\_bloaty](/recipe_modules/fuchsia/api.py#1802)(self, build_results):**
...
&mdash; **def [test\_in\_shards](/recipe_modules/fuchsia/api.py#1184)(self, test_pool, build, timeout_secs=(40 \* 60)):**
...
&mdash; **def [test\_on\_host](/recipe_modules/fuchsia/api.py#726)(self, build):**
...
&mdash; **def [upload\_build\_artifacts](/recipe_modules/fuchsia/api.py#1619)(self, build_results):**
