...
&mdash; **def [analyze\_collect\_result](/recipe_modules/fuchsia/api.py#1101)(self, step_name, result, build_dir):**
...
&mdash; **def [analyze\_test\_results](/recipe_modules/fuchsia/api.py#1149)(self, step_name, test_results):**
...
&mdash; **def [build](/recipe_modules/fuchsia/api.py#469)(self, target, build_type, packages, variants=(), gn_args=[], ninja_targets=()):**
...
&mdash; **def [report\_test\_results](/recipe_modules/fuchsia/api.py#1172)(self, test_results):**
...
&emsp; **@property**<br>&mdash; **def [results\_dir\_on\_host](/recipe_modules/fuchsia/api.py#604)(self):**
...
&emsp; **@property**<br>&mdash; **def [results\_dir\_on\_target](/recipe_modules/fuchsia/api.py#599)(self):**

The directory on target to which target test results will be written.

&mdash; **def [run\_bloaty](/recipe_modules/fuchsia/api.py#1596)(self, build_results):**
...
&mdash; **def [test](/recipe_modules/fuchsia/api.py#985)(self, build, test_pool, test_cmds, device_type, timeout_secs=(40 \* 60), pave=True, external_network=False, requires_secrets=False):**
...
&mdash; **def [test\_on\_host](/recipe_modules/fuchsia/api.py#614)(self, build):**
...
&mdash; **def [upload\_build\_artifacts](/recipe_modules/fuchsia/api.py#1410)(self, build_results, bucket, upload_breakpad_symbols=False):**
