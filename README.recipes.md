...
&mdash; **def [analyze\_collect\_result](/recipe_modules/fuchsia/api.py#1346)(self, step_name, result, build_dir):**
...
&mdash; **def [analyze\_test\_results](/recipe_modules/fuchsia/api.py#1394)(self, test_results):**
...
&mdash; **def [build](/recipe_modules/fuchsia/api.py#552)(self, target, build_type, packages, variants=(), gn_args=[], ninja_targets=(), boards=[], products=[], zircon_args=[]):**
...
&mdash; **def [report\_test\_results](/recipe_modules/fuchsia/api.py#1416)(self, test_results):**
...
&emsp; **@property**<br>&mdash; **def [results\_dir\_on\_host](/recipe_modules/fuchsia/api.py#694)(self):**
...
&emsp; **@property**<br>&mdash; **def [results\_dir\_on\_target](/recipe_modules/fuchsia/api.py#689)(self):**

The directory on target to which target test results will be written.

&mdash; **def [run\_bloaty](/recipe_modules/fuchsia/api.py#1822)(self, build_results):**
...
&mdash; **def [test](/recipe_modules/fuchsia/api.py#1085)(self, build, test_pool, test_cmds, device_type, timeout_secs=(40 \* 60), pave=True, external_network=False, requires_secrets=False):**
...
&mdash; **def [test\_in\_shards](/recipe_modules/fuchsia/api.py#1205)(self, test_pool, build, timeout_secs=(40 \* 60)):**
...
&mdash; **def [test\_on\_host](/recipe_modules/fuchsia/api.py#704)(self, build):**
...
&mdash; **def [upload\_build\_artifacts](/recipe_modules/fuchsia/api.py#1635)(self, build_results, bucket, upload_breakpad_symbols=False):**
...
&mdash; **def [checkout\_snapshot](/recipe_modules/jiri/api.py#392)(self, snapshot, timeout_secs=None):**
...
&mdash; **def [read\_manifest\_element](/recipe_modules/jiri/api.py#409)(self, manifest, element_type, element_name):**
