...
&mdash; **def [build](/recipe_modules/fuchsia/api.py#530)(self, target, build_type, packages, variants=(), gn_args=[], ninja_targets=(), boards=[], products=[], zircon_args=[]):**
...
&mdash; **def [checkout](/recipe_modules/fuchsia/api.py#221)(self, build_input, manifest, remote, project=None, timeout_secs=(20 \* 60)):**
...
&mdash; **def [checkout\_patched\_snapshot](/recipe_modules/fuchsia/api.py#307)(self, gerrit_change, timeout_secs=(20 \* 60)):**
...
&mdash; **def [checkout\_snapshot](/recipe_modules/fuchsia/api.py#266)(self, repository=None, revision=None, gitiles_commit=None, timeout_secs=(20 \* 60)):**
...
&mdash; **def [report\_test\_results](/recipe_modules/fuchsia/api.py#1393)(self, test_results):**
...
&emsp; **@property**<br>&mdash; **def [results\_dir\_on\_host](/recipe_modules/fuchsia/api.py#672)(self):**
...
&emsp; **@property**<br>&mdash; **def [results\_dir\_on\_target](/recipe_modules/fuchsia/api.py#667)(self):**
...
&mdash; **def [test](/recipe_modules/fuchsia/api.py#1053)(self, build, test_pool, test_cmds, device_type, timeout_secs=(40 \* 60), pave=True, external_network=False, requires_secrets=False):**
...
&mdash; **def [test\_in\_shards](/recipe_modules/fuchsia/api.py#1173)(self, test_pool, build, timeout_secs=(40 \* 60)):**
...
&mdash; **def [test\_on\_host](/recipe_modules/fuchsia/api.py#682)(self, build):**
...
&mdash; **def [upload\_build\_artifacts](/recipe_modules/fuchsia/api.py#1612)(self, build_results):**
...
&mdash; **def [RunSteps](/recipes/fuchsia.py#142)(api, project, manifest, remote, checkout_snapshot, target, build_type, packages, variant, gn_args, test_pool, run_tests, runtests_args, run_host_tests, device_type, networking_for_tests, pave, ninja_targets, test_timeout_secs, requires_secrets, test_in_shards, boards, products, zircon_args):**
