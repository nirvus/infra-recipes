...
&mdash; **def [checkout](/recipe_modules/jiri/api.py#164)(self, manifest, remote, patch_ref=None, patch_gerrit_url=None, project=None):**

&mdash; **def [clean](/recipe_modules/jiri/api.py#92)(self, all=False, \*\*kwargs):**

&mdash; **def [edit\_manifest](/recipe_modules/jiri/api.py#111)(self, manifest, projects=None, imports=None, \*\*kwargs):**

&mdash; **def [ensure\_jiri](/recipe_modules/jiri/api.py#22)(self, version=None):**

&mdash; **def [import\_manifest](/recipe_modules/jiri/api.py#101)(self, manifest, remote, name=None, overwrite=False, \*\*kwargs):**
...
&mdash; **def [BuildFuchsia](/recipes/fuchsia.py#116)(api, build_type, target, gn_target, fuchsia_build_dir, modules, tests, use_autorun, gn_args):**

&mdash; **def [BuildZircon](/recipes/fuchsia.py#91)(api, target, tests):**

&mdash; **def [Checkout](/recipes/fuchsia.py#71)(api, patch_project, patch_ref, patch_gerrit_url, project, manifest, remote):**

&mdash; **def [RunSteps](/recipes/fuchsia.py#322)(api, category, patch_gerrit_url, patch_project, patch_ref, patch_storage, patch_repository_url, project, manifest, remote, target, build_type, modules, tests, use_autorun, goma_dir, gn_args):**

&mdash; **def [RunTestsWithAutorun](/recipes/fuchsia.py#228)(api, target, fuchsia_build_dir):**

&mdash; **def [RunTestsWithTCP](/recipes/fuchsia.py#162)(api, target, fuchsia_build_dir, tests):**
