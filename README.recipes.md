...
#### **class [FuchsiaApi](/recipe_modules/fuchsia/api.py#145)([RecipeApi][recipe_engine/wkt/RecipeApi]):**

APIs for checking out, building, and testing Fuchsia.

&mdash; **def [analyze\_collect\_result](/recipe_modules/fuchsia/api.py#1328)(self, step_name, result, build_dir):**
...
&mdash; **def [analyze\_test\_results](/recipe_modules/fuchsia/api.py#1376)(self, test_results):**
...
&mdash; **def [build](/recipe_modules/fuchsia/api.py#563)(self, target, build_type, packages, variants=(), gn_args=[], ninja_targets=(), boards=[], products=[], zircon_args=[], collect_build_metrics=False, build_for_testing=False, build_archive=False, build_package_archive=False):**
...
&mdash; **def [checkout\_patched\_snapshot](/recipe_modules/fuchsia/api.py#329)(self, gerrit_change, timeout_secs=(20 \* 60)):**
...
&mdash; **def [checkout\_snapshot](/recipe_modules/fuchsia/api.py#288)(self, repository=None, revision=None, gitiles_commit=None, timeout_secs=(20 \* 60)):**
...
&mdash; **def [report\_test\_results](/recipe_modules/fuchsia/api.py#1402)(self, test_results):**
...
&emsp; **@property**<br>&mdash; **def [results\_dir\_on\_host](/recipe_modules/fuchsia/api.py#723)(self):**
...
&emsp; **@property**<br>&mdash; **def [results\_dir\_on\_target](/recipe_modules/fuchsia/api.py#718)(self):**

The directory on target to which target test results will be written.

&mdash; **def [test](/recipe_modules/fuchsia/api.py#1075)(self, build, test_pool, test_cmds, device_type, timeout_secs=(40 \* 60), pave=True, external_network=False, requires_secrets=False):**
...
&mdash; **def [test\_in\_shards](/recipe_modules/fuchsia/api.py#1186)(self, test_pool, build, timeout_secs=(40 \* 60)):**
...
&mdash; **def [test\_on\_host](/recipe_modules/fuchsia/api.py#733)(self, build):**
...
&mdash; **def [checkout](/recipe_modules/jiri/api.py#335)(self, manifest, remote, project=None, build_input=None, timeout_secs=None, run_hooks=True, local_manifest=True):**
...
&mdash; **def [checkout\_snapshot](/recipe_modules/jiri/api.py#423)(self, snapshot, timeout_secs=None):**
...
&mdash; **def [emit\_source\_manifest](/recipe_modules/jiri/api.py#330)(self):**
...
&mdash; **def [override](/recipe_modules/jiri/api.py#280)(self, project, manifest, remote, new_revision=None):**
...
&mdash; **def [read\_manifest\_element](/recipe_modules/jiri/api.py#440)(self, manifest, element_type, element_name):**
...
&mdash; **def [snapshot](/recipe_modules/jiri/api.py#296)(self, file=None, test_data=None, \*\*kwargs):**

&mdash; **def [source\_manifest](/recipe_modules/jiri/api.py#309)(self, file=None, test_data=None, \*\*kwargs):**
...
&mdash; **def [RunSteps](/recipe_modules/jiri/examples/full.py#31)(api, tryjob, local_manifest, checkout_from_snapshot):**
...
&mdash; **def [GetNextReleaseTag](/recipes/release/snapshot.py#48)(api, remote):**
...
&mdash; **def [UploadArchive](/recipes/sdk.py#190)(api, sdk, out_dir, remote, revision):**
...
&mdash; **def [RunSteps](/recipes/tricium/clang_tidy.py#40)(api, project, manifest, checks):**
### *recipes* / [tricium/format](/recipes/tricium/format.py)

[DEPS](/recipes/tricium/format.py#11): [git](#recipe_modules-git), [jiri](#recipe_modules-jiri), [recipe\_engine/buildbucket][recipe_engine/recipe_modules/buildbucket], [recipe\_engine/cipd][recipe_engine/recipe_modules/cipd], [recipe\_engine/context][recipe_engine/recipe_modules/context], [recipe\_engine/path][recipe_engine/recipe_modules/path], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/raw\_io][recipe_engine/recipe_modules/raw_io], [recipe\_engine/step][recipe_engine/recipe_modules/step], [recipe\_engine/tricium][recipe_engine/recipe_modules/tricium]

Recipe for running Tricium FuchsiaFormat analyzer.

&mdash; **def [RunSteps](/recipes/tricium/format.py#74)(api, project, manifest, formatters):**
...
&mdash; **def [RunSteps](/recipes/web_view.py#24)(api):**
