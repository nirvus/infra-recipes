...
&mdash; **def [analyze\_collect\_result](/recipe_modules/fuchsia/api.py#1349)(self, step_name, result, build_dir):**
...
&mdash; **def [analyze\_test\_results](/recipe_modules/fuchsia/api.py#1397)(self, test_results):**
...
&mdash; **def [report\_test\_results](/recipe_modules/fuchsia/api.py#1419)(self, test_results):**
...
&mdash; **def [run\_bloaty](/recipe_modules/fuchsia/api.py#1825)(self, build_results):**
...
&mdash; **def [test](/recipe_modules/fuchsia/api.py#1088)(self, build, test_pool, test_cmds, device_type, timeout_secs=(40 \* 60), pave=True, external_network=False, requires_secrets=False):**
...
&mdash; **def [test\_in\_shards](/recipe_modules/fuchsia/api.py#1208)(self, test_pool, build, timeout_secs=(40 \* 60)):**
...
&mdash; **def [upload\_build\_artifacts](/recipe_modules/fuchsia/api.py#1638)(self, build_results, bucket, upload_breakpad_symbols=False):**
