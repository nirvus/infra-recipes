...
#### **class [FuchsiaApi](/recipe_modules/fuchsia/api.py#111)([RecipeApi][recipe_engine/wkt/RecipeApi]):**
...
&mdash; **def [build](/recipe_modules/fuchsia/api.py#532)(self, target, build_type, packages, variants=(), gn_args=[], ninja_targets=(), boards=[], products=[], zircon_args=[]):**
...
&mdash; **def [checkout](/recipe_modules/fuchsia/api.py#217)(self, manifest, remote, project=None, build_input=None, revision=None, patch_ref=None, patch_gerrit_url=None, patch_project=None, snapshot_gcs_bucket=None, timeout_secs=(20 \* 60)):**
...
&mdash; **def [checkout\_patched\_snapshot](/recipe_modules/fuchsia/api.py#309)(self, gerrit_change=None, patch_gerrit_url=None, patch_issue=None, patch_project=None, patch_ref=None, patch_repository_url=None, timeout_secs=(20 \* 60)):**
...
&mdash; **def [checkout\_snapshot](/recipe_modules/fuchsia/api.py#268)(self, repository=None, revision=None, gitiles_commit=None, timeout_secs=(20 \* 60)):**
...
&mdash; **def [report\_test\_results](/recipe_modules/fuchsia/api.py#1399)(self, test_results):**
...
&emsp; **@property**<br>&mdash; **def [results\_dir\_on\_host](/recipe_modules/fuchsia/api.py#674)(self):**
...
&emsp; **@property**<br>&mdash; **def [results\_dir\_on\_target](/recipe_modules/fuchsia/api.py#669)(self):**

The directory on target to which target test results will be written.

&mdash; **def [run\_bloaty](/recipe_modules/fuchsia/api.py#1805)(self, build_results):**
...
&mdash; **def [test](/recipe_modules/fuchsia/api.py#1068)(self, build, test_pool, test_cmds, device_type, timeout_secs=(40 \* 60), pave=True, external_network=False, requires_secrets=False):**
...
&mdash; **def [test\_in\_shards](/recipe_modules/fuchsia/api.py#1188)(self, test_pool, build, timeout_secs=(40 \* 60)):**
...
&mdash; **def [test\_on\_host](/recipe_modules/fuchsia/api.py#684)(self, build):**
...
&mdash; **def [upload\_build\_artifacts](/recipe_modules/fuchsia/api.py#1618)(self, build_results, bucket, upload_breakpad_symbols=False):**
...
&mdash; **def [collect](/recipe_modules/swarming/api.py#317)(self, timeout=None, requests_json=None, tasks=[]):**
...
&mdash; **def [spawn\_tasks](/recipe_modules/swarming/api.py#290)(self, tasks=(), json_output=None):**
...
&emsp; **@property**<br>&mdash; **def [swarming\_client](/recipe_modules/swarming/api.py#204)(self):**

&emsp; **@swarming_server.setter**<br>&mdash; **def [swarming\_server](/recipe_modules/swarming/api.py#213)(self, value):**

Changes URL of Swarming server to use.

&mdash; **def [task\_request](/recipe_modules/swarming/api.py#281)(self, \*args, \*\*kwargs):**
...
&mdash; **def [trigger](/recipe_modules/swarming/api.py#218)(self, name, raw_cmd, isolated=None, dump_json=None, dimensions=None, expiration=None, io_timeout=None, hard_timeout=None, idempotent=False, cipd_packages=None, outputs=None):**
...
&mdash; **def [RunSteps](/recipes/fuchsia.py#163)(api, project, manifest, remote, checkout_snapshot, target, build_type, packages, variant, gn_args, test_pool, run_tests, runtests_args, run_host_tests, device_type, networking_for_tests, pave, ninja_targets, test_timeout_secs, requires_secrets, test_in_shards, archive_gcs_bucket, upload_breakpad_symbols, snapshot_gcs_bucket, boards, products, zircon_args):**
...
&mdash; **def [RunSteps](/recipe_modules/fuchsia/examples/fuchsia.py#132)(api, project, manifest, remote, checkout_snapshot, target, build_type, packages, variants, gn_args, ninja_targets, run_tests, runtests_args, device_type, run_host_tests, networking_for_tests, requires_secrets, snapshot_gcs_bucket, upload_breakpad_symbols, pave, boards, products, zircon_args, test_in_shards):**
...
&mdash; **def [RunSteps](/recipes/fuchsia_perf.py#139)(api, project, manifest, remote, target, build_type, packages, variant, gn_args, ninja_targets, test_pool, catapult_url, device_type, pave, dashboard_masters_name, dashboard_bots_name, snapshot_gcs_bucket, upload_to_dashboard, benchmarks_package, boards, products):**
...
[DEPS](/recipes/sdk.py#13): [bazel](#recipe_modules-bazel), [cipd](#recipe_modules-cipd), [fuchsia](#recipe_modules-fuchsia), [go](#recipe_modules-go), [gsutil](#recipe_modules-gsutil), [hash](#recipe_modules-hash), [jiri](#recipe_modules-jiri), [tar](#recipe_modules-tar), [recipe\_engine/context][recipe_engine/recipe_modules/context], [recipe\_engine/file][recipe_engine/recipe_modules/file], [recipe\_engine/json][recipe_engine/recipe_modules/json], [recipe\_engine/path][recipe_engine/recipe_modules/path], [recipe\_engine/platform][recipe_engine/recipe_modules/platform], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/python][recipe_engine/recipe_modules/python], [recipe\_engine/step][recipe_engine/recipe_modules/step]
...
&mdash; **def [UploadArchive](/recipes/sdk.py#209)(api, sdk, out_dir, remote, revision):**

&mdash; **def [UploadPackage](/recipes/sdk.py#169)(api, sdk_name, staging_dir, remote, revision):**
...
[DEPS](/recipes/web_view.py#9): [fuchsia](#recipe_modules-fuchsia), [gitiles](#recipe_modules-gitiles), [gsutil](#recipe_modules-gsutil), [hash](#recipe_modules-hash), [jiri](#recipe_modules-jiri), [recipe\_engine/buildbucket][recipe_engine/recipe_modules/buildbucket], [recipe\_engine/context][recipe_engine/recipe_modules/context], [recipe\_engine/properties][recipe_engine/recipe_modules/properties], [recipe\_engine/step][recipe_engine/recipe_modules/step]

Recipe for building libwebkit.so.

&mdash; **def [RunSteps](/recipes/web_view.py#34)(api, snapshot_gcs_bucket):**
