...
&mdash; **def [analyze\_test\_results](/recipe_modules/fuchsia/api.py#627)(self, step_name, test_results):**
...
&mdash; **def [RunSteps](/recipes/web_view.py#43)(api, patch_gerrit_url, patch_project, patch_ref, patch_storage, patch_repository_url, remote, manifest, project, target, upload_snapshot):**
