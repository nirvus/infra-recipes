...
&mdash; **def [analyze\_collect\_result](/recipe_modules/fuchsia/api.py#655)(self, step_name, result, zircon_build_dir):**
...
&mdash; **def [analyze\_test\_results](/recipe_modules/fuchsia/api.py#694)(self, step_name, test_results):**
...
&mdash; **def [build](/recipe_modules/fuchsia/api.py#298)(self, target, build_type, packages, variants=(), gn_args=(), ninja_targets=(), test_cmds=(), test_device_type='QEMU'):**
...
&mdash; **def [checkout](/recipe_modules/fuchsia/api.py#148)(self, manifest, remote, project=None, patch_ref=None, patch_gerrit_url=None, patch_project=None, snapshot_gcs_bucket=None, timeout_secs=(20 \* 60)):**
...
&mdash; **def [target\_test\_dir](/recipe_modules/fuchsia/api.py#409)(self):**

Returns the location of the mounted test directory on the target.

&mdash; **def [test](/recipe_modules/fuchsia/api.py#635)(self, build, timeout_secs=(40 \* 60)):**
...
&mdash; **def [import\_manifest](/recipe_modules/jiri/api.py#120)(self, manifest, remote, name=None, overwrite=False, \*\*kwargs):**
...
&mdash; **def [RunSteps](/recipes/fuchsia.py#85)(api, category, patch_gerrit_url, patch_project, patch_ref, patch_storage, patch_repository_url, project, manifest, remote, target, build_type, packages, variant, gn_args, run_tests, runtests_args, device_type, test_timeout_secs, upload_snapshot, snapshot_gcs_bucket, upload_archive):**
...
&mdash; **def [RunSteps](/recipe_modules/fuchsia/examples/fuchsia.py#64)(api, patch_gerrit_url, patch_project, patch_ref, project, manifest, remote, target, build_type, packages, variants, gn_args, ninja_targets, run_tests, runtests_args, device_type, snapshot_gcs_bucket):**
...
&mdash; **def [MakeSdk](/recipes/sdk.py#101)(api, outdir, sdk):**

&mdash; **def [PackageArchive](/recipes/sdk.py#106)(api, sdk):**
...
&mdash; **def [UploadArchive](/recipes/sdk.py#111)(api, sdk, digest):**

&mdash; **def [UploadPackage](/recipes/sdk.py#146)(api, outdir, digest):**
...
&mdash; **def [RunSteps](/recipes/tools.py#76)(api, category, patch_gerrit_url, patch_project, patch_ref, patch_storage, patch_repository_url, project, manifest, remote, revision, target, packages):**

&mdash; **def [UploadPackage](/recipes/tools.py#55)(api, name, target, staging_dir, revision, remote):**
...
&mdash; **def [RunSteps](/recipes/web_view.py#49)(api, patch_gerrit_url, patch_project, patch_ref, patch_storage, patch_repository_url, remote, manifest, project, target, upload_snapshot, snapshot_gcs_bucket):**
...
&mdash; **def [Build](/recipes/zircon.py#489)(api, target, toolchain, src_dir, needs_blkdev):**

Builds zircon and returns a path to the build output directory.

&mdash; **def [FinalizeTestsTasks](/recipes/zircon.py#440)(api, core_task, booted_task, booted_task_output_image, build_dir):**
...
&mdash; **def [GenerateQEMUCommand](/recipes/zircon.py#317)(target, cmdline, use_kvm, blkdev=''):**
...
&mdash; **def [RunSteps](/recipes/zircon.py#584)(api, category, patch_gerrit_url, patch_project, patch_ref, patch_storage, patch_repository_url, project, manifest, remote, target, toolchain, goma_dir, use_kvm, run_tests, device_type):**

&mdash; **def [RunTestsInQEMU](/recipes/zircon.py#190)(api, target, build_dir, use_kvm):**
...
&mdash; **def [TriggerTestsTask](/recipes/zircon.py#378)(api, name, cmd, arch, use_kvm, isolated_hash, output='', timeout_secs=(60 \* 60)):**
...
&emsp; **@contextlib.contextmanager**<br>&mdash; **def [no\_goma](/recipes/zircon.py#115)():**

[recipe_engine/recipe_modules/buildbucket]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/583ce62f5f4bb3a2d4821bc0568e39810c043b14/README.recipes.md#recipe_modules-buildbucket
...
[recipe_engine/wkt/non_step]: https://chromium.googlesource.com/infra/luci/recipes-py.git/+/583ce62f5f4bb3a2d4821bc0568e39810c043b14/recipe_engine/recipe_api.py#707
