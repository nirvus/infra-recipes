...
&mdash; **def [analyze\_collect\_result](/recipe_modules/fuchsia/api.py#1078)(self, step_name, result, build_dir):**
...
&mdash; **def [analyze\_test\_results](/recipe_modules/fuchsia/api.py#1126)(self, step_name, test_results):**
...
&mdash; **def [build](/recipe_modules/fuchsia/api.py#555)(self, target, build_type, packages, variants=(), gn_args=[], ninja_targets=(), test_cmds=(), test_device_type='QEMU'):**
...
&mdash; **def [checkout](/recipe_modules/fuchsia/api.py#245)(self, manifest, remote, project=None, revision=None, patch_ref=None, patch_gerrit_url=None, patch_project=None, snapshot_gcs_bucket=None, timeout_secs=(20 \* 60)):**
...
&mdash; **def [checkout\_patched\_snapshot](/recipe_modules/fuchsia/api.py#337)(self, patch_gerrit_url, patch_issue, patch_project, patch_ref, patch_repository_url, timeout_secs=(20 \* 60)):**
...
&mdash; **def [checkout\_snapshot](/recipe_modules/fuchsia/api.py#292)(self, repository, revision, timeout_secs=(20 \* 60)):**
...
&mdash; **def [report\_test\_results](/recipe_modules/fuchsia/api.py#1149)(self, test_results):**
...
&mdash; **def [run\_bloaty](/recipe_modules/fuchsia/api.py#1554)(self, build_results):**
...
&mdash; **def [test](/recipe_modules/fuchsia/api.py#1043)(self, build, test_pool, timeout_secs=(40 \* 60), pave=True, external_network=False):**
...
&mdash; **def [upload\_build\_artifacts](/recipe_modules/fuchsia/api.py#1387)(self, build_results, bucket, upload_breakpad_symbols=False):**
...
&mdash; **def [RunSteps](/recipes/qemu.py#389)(api, repository, branch, revision, platform):**

&mdash; **def [build\_gettext](/recipes/qemu.py#240)(api, cipd_dir, pkg_dir, platform, host):**

&mdash; **def [build\_glib](/recipes/qemu.py#272)(api, cipd_dir, pkg_dir, platform, host):**

&mdash; **def [build\_libffi](/recipes/qemu.py#218)(api, cipd_dir, pkg_dir, platform, host):**

&mdash; **def [build\_pixman](/recipes/qemu.py#177)(api, cipd_dir, pkg_dir, platform, host):**

&mdash; **def [build\_qemu](/recipes/qemu.py#297)(api, cipd_dir, pkg_dir, platform, host):**

&mdash; **def [build\_sdl](/recipes/qemu.py#199)(api, cipd_dir, pkg_dir, platform, env={}):**
...
&mdash; **def [Build](/recipes/zircon.py#480)(api, target, toolchain, make_args, src_dir, test_cmd, needs_blkdev, device_type):**

Builds zircon and returns a path to the build output directory.

&mdash; **def [FinalizeTestsTasks](/recipes/zircon.py#389)(api, core_task, booted_task, booted_task_output_image, build_dir):**
...
&mdash; **def [RunSteps](/recipes/zircon.py#564)(api, patch_gerrit_url, patch_project, patch_ref, patch_storage, patch_repository_url, project, manifest, remote, revision, target, toolchain, make_args, use_kvm, run_tests, runtests_args, device_type, run_host_tests):**

&mdash; **def [RunTestsInQEMU](/recipes/zircon.py#241)(api, target, build_dir, use_kvm):**
...
&mdash; **def [RunTestsOnDevice](/recipes/zircon.py#168)(api, target, build_dir, device_type):**
...
&mdash; **def [TriggerTestsTask](/recipes/zircon.py#324)(api, name, cmd, arch, use_kvm, isolated_hash, output='', timeout_secs=(60 \* 60)):**
