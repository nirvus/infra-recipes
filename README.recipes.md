...
&mdash; **def [run\_bloaty](/recipe_modules/fuchsia/api.py#1798)(self, build_results):**
...
&mdash; **def [upload\_build\_artifacts](/recipe_modules/fuchsia/api.py#1615)(self, build_results):**
