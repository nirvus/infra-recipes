...
#### **class [FuchsiaApi](/recipe_modules/fuchsia/api.py#158)([RecipeApi][recipe_engine/wkt/RecipeApi]):**

APIs for checking out, building, and testing Fuchsia.

&mdash; **def [analyze\_collect\_result](/recipe_modules/fuchsia/api.py#788)(self, step_name, result, zircon_build_dir):**
...
&mdash; **def [analyze\_test\_results](/recipe_modules/fuchsia/api.py#829)(self, step_name, test_results):**
...
&mdash; **def [build](/recipe_modules/fuchsia/api.py#376)(self, target, build_type, packages, variants=(), gn_args=[], ninja_targets=(), test_cmds=(), test_device_type='QEMU'):**
...
&mdash; **def [checkout](/recipe_modules/fuchsia/api.py#187)(self, manifest, remote, project=None, patch_ref=None, patch_gerrit_url=None, patch_project=None, snapshot_gcs_bucket=None, timeout_secs=(20 \* 60)):**
...
&mdash; **def [target\_test\_dir](/recipe_modules/fuchsia/api.py#536)(self):**

Returns the location of the mounted test directory on the target.

&mdash; **def [test](/recipe_modules/fuchsia/api.py#768)(self, build, timeout_secs=(40 \* 60)):**
