...
&mdash; **def [BuildFuchsia](/recipes/fuchsia.py#119)(api, build_type, target, gn_target, fuchsia_build_dir, modules, use_goma, gn_args):**

&mdash; **def [BuildMagenta](/recipes/fuchsia.py#89)(api, target, tests):**

&mdash; **def [Checkout](/recipes/fuchsia.py#63)(api, patch_project, patch_ref, patch_gerrit_url, manifest, remote):**

&emsp; **@contextmanager**<br>&mdash; **def [GomaContext](/recipes/fuchsia.py#110)(api, use_goma):**

&mdash; **def [RunSteps](/recipes/fuchsia.py#250)(api, category, patch_gerrit_url, patch_project, patch_ref, patch_storage, patch_repository_url, manifest, remote, target, build_type, modules, tests, use_goma, gn_args):**

&mdash; **def [RunTests](/recipes/fuchsia.py#161)(api, target, fuchsia_build_dir):**

&mdash; **def [UploadArchive](/recipes/fuchsia.py#232)(api, target, magenta_build_dir, fuchsia_build_dir):**
