...
&mdash; **def [analyze\_collect\_result](/recipe_modules/fuchsia/api.py#601)(self, step_name, result, zircon_build_dir):**
...
&mdash; **def [analyze\_test\_results](/recipe_modules/fuchsia/api.py#640)(self, step_name, test_results):**
...
&mdash; **def [build](/recipe_modules/fuchsia/api.py#264)(self, target, build_type, packages, variants=(), gn_args=(), ninja_targets=(), test_cmds=(), test_in_qemu=True):**
...
&mdash; **def [checkout](/recipe_modules/fuchsia/api.py#120)(self, manifest, remote, project=None, patch_ref=None, patch_gerrit_url=None, patch_project=None, upload_snapshot=False, timeout_secs=(20 \* 60)):**
...
&mdash; **def [target\_test\_dir](/recipe_modules/fuchsia/api.py#371)(self):**

Returns the location of the mounted test directory on the target.

&mdash; **def [test](/recipe_modules/fuchsia/api.py#375)(self, build, timeout_secs=(40 \* 60)):**
...
&mdash; **def [test\_on\_device](/recipe_modules/fuchsia/api.py#524)(self, device_type, build, timeout_secs=(40 \* 60)):**
...
&mdash; **def [Build](/recipes/zircon.py#536)(api, target, toolchain, src_dir, use_isolate, needs_blkdev):**

Builds zircon and returns a path to the build output directory.

&mdash; **def [FinalizeTestsTasks](/recipes/zircon.py#487)(api, core_task, booted_task, booted_task_output_image, build_dir):**
...
&mdash; **def [GenerateQEMUCommand](/recipes/zircon.py#365)(target, cmdline, use_kvm, blkdev=''):**
...
&mdash; **def [RunSteps](/recipes/zircon.py#629)(api, category, patch_gerrit_url, patch_project, patch_ref, patch_storage, patch_repository_url, project, manifest, remote, target, toolchain, goma_dir, use_isolate, use_kvm, run_tests, device_type):**

&mdash; **def [RunTests](/recipes/zircon.py#128)(api, name, build_dir, \*args, \*\*kwargs):**

&mdash; **def [RunTestsInQEMU](/recipes/zircon.py#238)(api, target, build_dir, use_kvm):**
...
&mdash; **def [TriggerTestsTask](/recipes/zircon.py#425)(api, name, cmd, arch, use_kvm, isolated_hash, output='', timeout_secs=(60 \* 60)):**
...
&emsp; **@contextlib.contextmanager**<br>&mdash; **def [no\_goma](/recipes/zircon.py#123)():**
