...
&mdash; **def [analyze\_collect\_result](/recipe_modules/fuchsia/api.py#1197)(self, step_name, result, build_dir):**
...
&mdash; **def [analyze\_test\_results](/recipe_modules/fuchsia/api.py#1245)(self, test_results):**
...
&mdash; **def [build](/recipe_modules/fuchsia/api.py#547)(self, target, build_type, packages, variants=(), gn_args=[], ninja_targets=(), boards=[], products=[], zircon_args=[]):**
...
&mdash; **def [checkout](/recipe_modules/fuchsia/api.py#225)(self, manifest, remote, project=None, build_input=None, revision=None, patch_ref=None, patch_gerrit_url=None, patch_project=None, snapshot_gcs_bucket=None, timeout_secs=(20 \* 60)):**
...
&mdash; **def [checkout\_patched\_snapshot](/recipe_modules/fuchsia/api.py#317)(self, gerrit_change=None, patch_gerrit_url=None, patch_issue=None, patch_project=None, patch_ref=None, patch_repository_url=None, timeout_secs=(20 \* 60)):**
...
&mdash; **def [checkout\_snapshot](/recipe_modules/fuchsia/api.py#276)(self, repository=None, revision=None, gitiles_commit=None, timeout_secs=(20 \* 60)):**
...
&mdash; **def [report\_test\_results](/recipe_modules/fuchsia/api.py#1267)(self, test_results):**
...
&emsp; **@property**<br>&mdash; **def [results\_dir\_on\_host](/recipe_modules/fuchsia/api.py#689)(self):**
...
&emsp; **@property**<br>&mdash; **def [results\_dir\_on\_target](/recipe_modules/fuchsia/api.py#684)(self):**

The directory on target to which target test results will be written.

&mdash; **def [run\_bloaty](/recipe_modules/fuchsia/api.py#1692)(self, build_results):**
...
&mdash; **def [test](/recipe_modules/fuchsia/api.py#1078)(self, build, test_pool, test_cmds, device_type, timeout_secs=(40 \* 60), pave=True, external_network=False, requires_secrets=False):**
...
&mdash; **def [test\_on\_host](/recipe_modules/fuchsia/api.py#699)(self, build):**
...
&mdash; **def [upload\_build\_artifacts](/recipe_modules/fuchsia/api.py#1505)(self, build_results, bucket, upload_breakpad_symbols=False):**
