...
&mdash; **def [analyze\_collect\_result](/recipe_modules/fuchsia/api.py#1311)(self, step_name, result, build_dir):**
...
&mdash; **def [run\_bloaty](/recipe_modules/fuchsia/api.py#1791)(self, build_results):**
...
&mdash; **def [test](/recipe_modules/fuchsia/api.py#1045)(self, build, test_pool, test_cmds, device_type, timeout_secs=(40 \* 60), pave=True, external_network=False, requires_secrets=False):**
...
&mdash; **def [test\_in\_shards](/recipe_modules/fuchsia/api.py#1165)(self, test_pool, build, timeout_secs=(40 \* 60)):**
...
&mdash; **def [upload\_build\_artifacts](/recipe_modules/fuchsia/api.py#1604)(self, build_results, bucket, upload_breakpad_symbols=False):**
