...
class FuchsiaApi(recipe_api.RecipeApi):
  ...
  def upload_build_results(self, build_results):
    ...
    * Optionally, symbols for the Fuchsia binaries
    ...
    if self._build_metrics_gcs_bucket:
      self._upload_tracing_data(build_results)
      self._run_bloaty(build_results)
  ...
  def _upload_tracing_data(self, build_results):
  ...
  def _run_bloaty(self, build_results):
