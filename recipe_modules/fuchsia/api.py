...
class FuchsiaApi(recipe_api.RecipeApi):
  ...
  # TODO(joshuaseaton): Disable the following function and its callsite until we
  # can be sure the needed contents of packages.tar.gz are generated at build
  # time.
  ...
  def upload_build_results(self,
    ...
    * Optionally, symbols for the Fuchsia binaries
    ...
    if gcs_bucket or self._archive_gcs_bucket:
      ...
      # TODO(joshuaseaton): Disable the following steps until we can be sure\
